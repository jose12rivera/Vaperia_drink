    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EstadisticaVentaId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Fecha = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CantidadVentas = table.Column<int>(type: "INTEGER", nullable: false),
                    TotalVendido = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ProductosVendidos = table.Column<int>(type: "INTEGER", nullable: false),
                    Disminuye = table.Column<int>(type: "INTEGER", nullable: false),
                    Aumenta = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstadisticaVentas", x => x.EstadisticaVentaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Facturas_MetodosPagos_MetodoPagoId",
